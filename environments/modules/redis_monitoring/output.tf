...
#     redis_eviction = google_monitoring_alert_policy.redis_eviction.id
...
#     redis_eviction = google_monitoring_alert_policy.redis_eviction.name

#   }
# }

output "redis_memory_utilization" {
  value = google_monitoring_alert_policy.redis_memory_utilization.name
